...
Enter 5 : To Add student data
	...
	if(userInput == 1): #This Option Will Print List Of Students
		...
		if(srcStd in Stddata): #This Condition Searching The Student
	...
	elif(userInput == 5): #This Option Will Add Student details
		newStddat = input("Enter Roll no: ")
		newStddat1 = input("Enter address: ")
		newStddat2 = input("Enter phno: ")
		newStddat3 = input("Enter Student name: ")
		if(newStddat in Stddata): #This Condition Checking The New Student Is Already In List Ur Not
			print("\nThis Student {} Already In The Database".format(newStddat,newStddat1,newStddat2,newStddat3))  #Error Message
		else:	
			Stddata.append(newStddat)
			Stddata.append(newStddat1)
			Stddata.append(newStddat2)
			Stddata.append(newStddat3)
			print("\n=> New Student details {} Successfully Add \n".format(newStddat,newStddat1,newStddat2,newStddat3))
			for students in Stddata:
				print("=> {}".format(students))	
